...
//    private static br.usjt.deswebmob.activitylifecycle.util.StatusTracker mStatusTracker = br.usjt.deswebmob.activitylifecycle.util.StatusTracker.getInstance();
//    não é necessário o passar o nome completo do package pois as classes estão no mesmo package
